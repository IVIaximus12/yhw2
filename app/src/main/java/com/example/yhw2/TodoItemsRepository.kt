...
class TodoItemsRepository {
    ...
    fun getTasks() = listOf<TodoItem>(
        ...
        TodoItem("2", "Действие игры происходит в 2010 году. Несмотря на трагедию, произошедшую на острове из первой части, эксперименты с «Третьей Энергией» продолжаются в городе Эдвард-Сити. Но, как и в прошлый раз, всё идёт не так, и весь Эдвард-Сити с его окрестностями переносит в прошлое — во времена динозавров.", false),
